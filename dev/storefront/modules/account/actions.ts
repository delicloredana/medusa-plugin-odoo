...
export async function signUp(
  ...
  formData: StorePostCustomersCustomerReq
) {
  const customer = {
  ...
  redirect(`/${countryCode}/my-account`);
}
...
export async function addCustomerShippingAddress(data: any) {
  const customer = {
    address: {
...
export async function updateCustomerShippingAddress(
  ...
  formData: StorePostCustomersCustomerAddressesAddressReq
) {
  ...
  const address = {
    ...
    address_2: formData.address_2 as string,
